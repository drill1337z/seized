...
function AddWindow(options)
    ...
    function menu:AddTab(options)
        ...
        do
            ...
            TabContainer.MouseEnter:Connect(
                function()
                    tab.MouseInside = true
                end
            )

            TabContainer.MouseLeave:Connect(
                function()
        ...
        function tab:AddSection(options)
            ...
            -- Hovering
            do
                Section.MouseEnter:Connect(
                    function()
                        Library:tween(HoverLine, {BackgroundTransparency = 0})
                    end
                )

                Section.MouseLeave:Connect(
                    function()
            ...
            function section:AddSlider(options)
                ...
                function slider:SetValue(v)
                    if v == nil then
                        ...
                        local slidervalue =
                            math.clamp(
                            math.round(output * (options.max - options.min) + options.min),
                            options.min,
                            options.max
                        )
                ...
                -- Functionality
                do
                    SliderBackground.MouseEnter:Connect(
                        function()
                            slider.Hover = true
                    ...
                    SliderBackground.MouseLeave:Connect(
                        function()
                            slider.Hover = false
            ...
            function section:AddDropdown(options)
                ...
                do
                    ActiveChoice.MouseEnter:Connect(
                        function()
                            dropdown.Hover = true
                    ...
                    ActiveChoice.MouseLeave:Connect(
                        function()
    ...
    do
        ...
        InnerContainer.MouseEnter:Connect(
            function()
                container.Hover = true
            end
        )

        InnerContainer.MouseLeave:Connect(
            function()
        ...
        Container1.InputChanged:Connect(
            function(input)
